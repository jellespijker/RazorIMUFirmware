    ...
    if(NOT TARGET ${TARGET_LIB_NAME})
        ...
        if(LIB_SRCS)
            ...
            foreach(LIB_DEP ${LIB_DEPS})
                if (NOT ${LIB_PATH} STREQUAL ${LIB_DEP})
...
if(NOT ARDUINO_FOUND AND ARDUINO_SDK_PATH)
    ...
    register_hardware_platform(${ARDUINO_SDK_PATH}/hardware/avr/${ARDUINO_SDK_VERSION}/)
    ...
    find_file(ARDUINO_LIBRARIES_PATH_PLATFORM
            NAMES libraries
            PATHS ${ARDUINO_SDK_PATH}/hardware/avr/${ARDUINO_SDK_VERSION}/
            DOC "Path to directory containing the Arduino platform libraries.")
